...
public class PlayerProfile extends Activity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0){
                PlayerTabProfile ptf1 = new PlayerTabProfile();
                return ptf1;
            }
            else if (position==1){
                OddStat ods = new OddStat();
                return ods;
            }else if (position == 2){
                BowlStat bst = new BowlStat();
                return bst;
            }
