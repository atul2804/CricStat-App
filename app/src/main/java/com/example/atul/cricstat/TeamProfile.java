...
public class TeamProfile extends Activity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 1){
                TeamTabPlayers tab1 = new TeamTabPlayers();
                return tab1;
            }else if (position == 0){
                TeamTabProfile tab = new TeamTabProfile();
                return tab;
            }else if(position == 2){
                TeamTabMatches matches = new TeamTabMatches();
                return matches;
            }
